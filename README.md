# Build WhatsApp Bots with Python
...
- [Build WhatsApp Bots with Pure Python](#build-whatsapp-bots-with-pure-python)
  ...
  - [Step 6: Integrate ruled chatbot into the Application](#step-6-integrate-ruled-chatBot-into-the-application)
